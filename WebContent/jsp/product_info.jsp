			...
			<div style="margin: 0 auto; width: 950px;">
				...
				<div class="col-md-6">
					...
					<div style="margin: 10px 0 10px 0;">
						亿家价: <strong style="color: #ef0101;">￥：${product.market_price }</strong>
						参 考 价：
					...
					<form
						action="${pageContext.request.contextPath }/cart?method=addPro"
						...
						<div
							...
							<div style="margin: 20px 0 10px 0;; text-align: center;">
								<a href="#"> <input
									...
									value="加入购物车" type="button" onclick="doSubmit()">
								</a> &nbsp;收藏商品
							</div>
						</div>
					</form>
