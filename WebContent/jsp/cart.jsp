...
<body>
	...
	<div class="container">
		<div class="row">
			...
			<c:if test="${empty cart.maps }">

				<h1>购物车空空如也，赶紧去购物吧</h1>

			</c:if>
			<c:if test="${not empty cart.maps }">
							...
							<c:forEach items="${cart.items }" var="item">
								<tr class="active">
									...
									<td><a href="javascript:;" class="delete"
										onclick="deleteFromCartByPid('${item.product.pid}')">删除</a></td>
								</tr>
				...
				<div style="margin-right: 130px;">
					...
					<div
						...
						<a href="${pageContext.request.contextPath }/cart?method=clear"
							id="clear" class="clear" onclick="">清空购物车</a> <a
...
<script type="text/javascript">
	function deleteFromCartByPid(pid) {
		/* 	location.href = "${pageContext.request.contextPath}/cart?method=remove&pid="
					...
					if(confirm("你确定要删除我吗?")){
						...
						location.href = "${pageContext.request.contextPath}/cart?method=deletFromCartByPid&pid="
							+ pid;
					}
